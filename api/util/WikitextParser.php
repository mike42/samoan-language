...
class WikitextParser {
	/* Bugs
	 * - Cannot nest ''' bold ''' inside ''italic'' (the italic will be closed and the bold not opened)
	 * - No support for magic words http://www.mediawiki.org/wiki/Help:Magic_words
	 * - nowiki, noinclude not currently supported
	 * - Unsafe tags not removed eg <script>
	 * - End markup model is not validated
	 * - No options to limit recursive depth
	 * - No infrastructure for templates to have arguments
	 * - Table properties (after {| and |- and |) are not put through the parser.
	 * - Table captions (|+) are not supported
	 * - Need to add checking for inline / lineblock elements into tables cell renderer
	 * - Signature/timestamp (~~~ ~~~~~ ~~~~) fornats not supported
	 */
	public static $block;
