...
class Letter_Model implements Model {
	...
	public static function cache_get_html($letter_id) {
		...
		if (! $row = self::$database -> retrieve ( $query, 1, $letter_id )) {
			return false;
		}
