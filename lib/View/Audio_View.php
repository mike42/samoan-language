...
class Audio_View implements View {
	...
	public function error_ogg(array $data) {
		header ( "HTTP/1.1 404 Not Found" );
		echo "<h1>404 Not Found</h1><hr /><p>That audio file does not exist!</p>";
	}
	public function error_mp3(array $data) {
		self::error_ogg ( $data );
	}
	public function listen_ogg(array $data) {
		self::redirTo ( $data, 'ogg' );
	}
	public function listen_mp3(array $data) {
		self::redirTo ( $data, 'mp3' );
	}
	public function redirTo($data, $format) {
